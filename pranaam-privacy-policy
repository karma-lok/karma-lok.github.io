...
[Pranaam] ("the App") is operated by [Chandresh Kumar] ("the developer"). This page informs users of the App ("you" or "the user") about the Developer's policies regarding the collection, use, and disclosure of personal data when using the App and the choices you have associated with that data.
...
If you have any questions or suggestions about the Privacy Policy, do not hesitate to contact the Developer at [chandresh@karmalok.com].
